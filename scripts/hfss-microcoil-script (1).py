...
#Import the design, not the best to be used have restrictions along the corners which are important for impedance matching
oEditor.ImportDXF(
...
# Calculate field report (how to setup multiple frequencies)
